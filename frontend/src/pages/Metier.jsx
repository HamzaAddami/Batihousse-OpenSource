...
const NosMetier = () => {
    ...
    return (
        <section className="w-full py-12 mb-4 md:py-24 lg:py-0" id="font-family">
            <div
                className=" text-primary border bg-card text-card-foreground shadow-sm mb-12 bg-quaternary"
                data-v0-t="card"
            >
                ...
                <div className="grid gap-14 lg:grid-cols-[1fr_300px]">
                    <div className="grid gap-12">
                        <section>
                            ...
                            <p className="text-gray-500 dark:text-gray-500 mb-">
                    ...
                    <div className="space-y-8">
                        ...
                        >
                            <div className="flex flex-col space-y-1.5 text-center">
                                <h3 className="whitespace-nowrap bg-quaternary py-4 px-4 text-2xl font-semibold leading-none tracking-tight">
                                    AVIS DE NOS CLIENTS
                                </h3>
                            </div>
                            <div className="p-6">
                                <blockquote className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        <img
                                            ...
                                            width="48"
                                            height="48"
                                            className="h-12 w-12 rounded-full mb-8"
                                        />
                                        <div>
