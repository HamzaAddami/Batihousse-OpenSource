...
const Section3 = () => {
    ...
    return (
        <section className="flex flex-col items-center justify-center space-y-10 py- md:py-16 ">
            ...
            <div className="flex w-full max-w-6xl flex-col items-center gap-8 md:flex-row">
                ...
                <div className="md:w-1/2 flex-1 space-y-4 text-center md:text-left pl-4 bg-tertiary py-3 px-5 "
                     data-aos="fade-left"
                     data-aos-duration="1200">
